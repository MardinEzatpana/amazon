    ...
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#767676] relative">
          <label className="block">مرتب سازی بر اساس:</label>
          <select
            id="countries"
          ...
          >
            <option value="Best Sellers">بیشترین فروش</option>
            <option value="New Arrival">محصولات جدید</option>
            <option value="Featured">محصولات برجسته</option>
            <option value="Final Offer">پیشنهاد ویژه</option>
          </select>
          <span className="absolute text-sm Left-2 md:left-4 top-2.5">
            <GoTriangleDown />
          </span>
        </div>
        <div className="flex items-center gap-2 text-[#767676] relative">
          ...
          <span className="absolute text-sm left-3 top-2.5">
            <GoTriangleDown />
          </span>
        </div>
      </div>
